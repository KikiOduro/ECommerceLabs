...
class User extends db_connection
{
    ...
    public function createUser($name, $email, $password, $country, $city, $phone_number, $role, $imagePath = null)
    {
        ...
        $stmt->bind_param("sssssssi", $name, $email, $hashed_password, $country, $city, $phone_number, $role, $imagePath);
        if ($stmt->execute()) {
